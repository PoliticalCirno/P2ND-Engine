        ...
        public class Maps // 0 = testmap, 1 = nmap
        {
            ...
            public static void LoadAll()
            {
                ...
                { 
                    ...
                    ligt.Add(new GameObjects.Lights(new Vector3(1f, 5f, 5f), new Vector3(10.5f, -1.0f, 5.0f), true, Light_types.Directorional, Raylib_cs.Color.Orange, 12.0f, Shadercl.Mat_PBR));
                    ligt.Add(new GameObjects.Lights(new Vector3(1f, 0f, 1f), new Vector3(10.5f, -1.0f, 4.0f), true, Light_types.Directorional, Raylib_cs.Color.RayWhite, 0.0f, Shadercl.Mat_PBR));  
                    ligt.Add(new GameObjects.Lights(new Vector3(1f, 5f, 5f), new Vector3(10.5f, -1.0f, 4.0f), true, Light_types.Directorional, Raylib_cs.Color.Blue, 12.0f, Shadercl.Mat_PBR));  
            ...
            public static void LoadPrereq()
            {
                ...
                modl.Add(new Mdl(LoadModel("resources/models/prereq/Def.glb"), 0x000003, 0x000000, LoadTexture("resources/models/prereq/default/DefaultTextureDiffuse.png"), LoadTexture("resources/models/test/demotex/concnorm.jpg"), LoadTexture("resources/models/prereq/default/DefaultTexture.png"),Shaders.Mat_PBR_Metallic, 0));
